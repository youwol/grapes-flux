...
import { FluxAppComponentName, FluxAppBlockName } from '../constants'

export class FluxAppBlock {
    public readonly blockType: string
    public readonly label = 'Flux-App'
    ...
    constructor(params: {
        ...
        this.blockType = this.idFactory(FluxAppBlockName)
        this.content = {
            type: this.idFactory(FluxAppComponentName),
        }
    }
}
